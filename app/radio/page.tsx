        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-ivory/50 text-base md:text-lg max-w-2xl mx-auto leading-relaxed font-light">
              بث مباشر وحوارات فلسفية معمقة. نقدم محتوى إذاعياً يلامس القضايا الفلسفية
              والتربوية والثقافية بأسلوب عصري شيق.
            </p>
            <Link
              href="/"
              className="inline-flex items-center gap-2 text-gold/60 hover:text-gold transition-colors mt-6 text-sm"
            >
              <ArrowRight size={14} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            <MediaPlaceholder type="image" title="صور الراديو" />
            <MediaPlaceholder type="video" title="فيديوهات الراديو" />
            <MediaPlaceholder type="audio" title="تسجيلات الراديو" />
          </div>
